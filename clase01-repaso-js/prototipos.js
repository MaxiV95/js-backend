...
function Comment(msg) {
	LikesService.call(this); // Para heredar 
	this.message = msg;
}

// Creamos objeto con propiedades del prototipos LikesService
Comment.prototype = Object.create(LikesService.prototype);
Comment.prototype.constructor = Comment; // Mantener consistencia
...
console.log(
	"Si llamamos a la función getComments vemos que viene vacía porque todavía no agregamos nada"
);
console.log(thread.getComments());
console.log("\n");

console.log(
	"Creamos una nueva instancia de un comentario con un mensaje que queramos"
);
...
console.log(
	"Vemos que nuestro comentario tiene un like dentro de nuestro thread"
);
console.log(thread.getComments());
